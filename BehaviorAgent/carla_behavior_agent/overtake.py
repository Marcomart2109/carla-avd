...
# -- Overtake ---------------------------------------------------
# ====================================================================
class Overtake(BasicAgent):
    """
    Overtake class that provides the logic to perform an overtaking maneuver.
    ...
    def run_step(
        ...
        self._overtake_ego_distance, hypotenuse = Overtake.get_overtake_distance(vehicle_length, lane_width, distance_same_lane, distance_other_lane, distance_from_object)

        # Get the overtake time that the agent needs to travel.
        overtake_time = Overtake.get_overtake_time(ego_vehicle=self._vehicle, overtake_distance=self._overtake_ego_distance)
